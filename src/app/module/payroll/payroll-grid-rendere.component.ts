...
@Component({
  selector: 'app-payroll-grid-rendere',
  templateUrl: './payroll-grid-rendere.component.html',
  styleUrls: ['./payroll-grid-rendere.component.scss']
})
export class PayrollGridRendereComponent implements OnInit {
